<template>
  <div class="info">
    <section class="tuition_fee info-section" v-if="tuitionFee">
      <div class="head">受講料（教材費・消費税等含む）</div>
      <div class="body">
        <div class="body-inner" v-html="tuitionFee"></div>
      </div>
    </section>
    <section class="capacity info-section" v-if="capacity">
      <div class="head">定員</div>
      <div class="body">
        <div class="body-inner" v-html="capacity"></div>
      </div>
    </section>
    <section class="benefits info-section" v-if="benefits">
      <div class="head">給付制度</div>
      <div class="body">
        <div class="body-inner" v-html="benefits"></div>
      </div>
    </section>
    <section class="cpds info-section" v-if="cpds">
      <div class="head">CPDS</div>
      <div class="body">
        <div class="body-inner" v-html="cpds"></div>
      </div>
    </section>
    <!-- オンライン講座 ↓ -->
    <section class="online course_outline info-section" v-if="courseOutline">
      <div class="head">講座概要</div>
      <div class="body">
        <div class="body-inner" v-html="courseOutline"></div>
      </div>
    </section>
      ...
      <div class="media">
        <div class="media-movie" v-if="mediaYoutube">
          <iframe
            width="560"
            height="315"
            :src="`https://www.youtube.com/embed/${mediaYoutube}`"

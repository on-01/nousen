<template>
  <section>
    <div class="merumaga-wrap -second">
      <div class="merumaga">
        <p class="merumaga-title">メルマガ資格情報サービス</p>
        <p class="merumaga-text">
          能センのメールマガジンでは、２級電気工事施工管理技士に関する最新情報や試験対策、勉強法、申請手続きなど、資格取得に役立つ様々な情報を定期的にお届けします。
          <br />
          <br />
          <span>試験情報</span>
          ...
          <br />
          <br />
          このメールマガジンを購読することで、２級電気工事施工管理技士の資格取得を目指す方々にとって有益な情報をいち早くキャッチし、スムーズに目標を達成する手助けとなります。
          <br />

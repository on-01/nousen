        ...
        <div class="follow-wrap">
          ...
          <div class="follow-flex">
            ...
            <div class="follow-textWrap">
              ...
              <p class="follow-text">
                能センレポは、受講生の学習状況や出欠状況を能センが確認・集計し、担当者様向けに進捗を可視化する管理サービスです。
                <br />
                オンライン講座・講習会それぞれに対応しています。
              </p>
              <p class="follow-heading">📅 サポート期間：試験日まで</p>
              <p class="follow-heading">💻 オンライン講座用</p>
              <p class="follow-text">
                ...
                ✅ 毎週、学習進捗レポートを作成・配信
                <br />
                👉 学習の遅れや離脱を早期に把握し、合格までのペース管理をサポートします。
              </p>
              <p class="follow-heading">📅 講習会用</p>
              <p class="follow-text">
                ✅ 講習会の出欠状況を確認・集計
                <br />
                ✅ 参加者・欠席者を一覧で表示
              ...
              <p class="follow-text">
                受講状況を「見える化」することで、学習の停滞や欠席防止につながります。
                <br />
                合格率向上・離脱防止を目指す、法人担当者様向けの進捗管理サポートです。
              </p>
            </div>
          </div>
          <div class="follow-flex">

      ...
      <div class="add-wrapper">
        ...
        <div class="add-studyWrap">
          ...
          <p class="add-text2">
            ...
            <span>✅法規</span>
            <br />
            【労働基準法】【労働安全衛生法】【建設業法】【道路法】【河川法】【建築基準法】ントまでわかりやすく指導します。
            <br />
            <br />
          ...
          <p class="add-text2">
            <span>✅施工経験記述</span>
            <br />
            【書き方】【記入例】【品質管理】【工程管理】【施工計画】【過去問】
            <br />
            <br />
            <span>✅各種の学科記述</span>
            <br />
            【土工】【コンクリート工】【安全管理】【建築副産物】
            <br />
            <br />
            <span>✅二次試験ポイント</span>
            <br />
            ...
            <br />
            経験記述問題に重点を置いた対策を行います。経験記述試験では、どのような問題が出題されるのか、書き方からポイント、注意点までわかりやすく説明いたします
            <br />
            ※本講習は「土木」を対象にしており、「鋼構造物塗装」「薬液注入」の講習は行いませんので、ご注意ください
            <br />
            <br />
            <span>【注意】</span>
            上記の学習内容の一部を実施しない場合がございます。状況に応じて省略・変更することがございますので、ご了承ください。
          </p>
        </div>
      </div>
      <div class="add-wrapper">

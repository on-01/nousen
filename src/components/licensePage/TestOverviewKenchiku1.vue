<template>
  <div class="test">
    <div class="test-inner">
      <p class="test-title">施工管理技術検定とは</p>
      <div class="test-wrap -orange -first">
        <p class="test-text">
          ...
          引用元：
          <a
            href="https://www.fcip-shiken.jp/index.html"
            target="_blank"
      ...
      <div class="test-wrap -white">
        <p class="test-index">施工管理技士ができること</p>
        <p class="test-text">
          施工管理技術検定の第二次検定に合格して「施工管理技士」の称号を得ると、建設業の許可基準の一つである営業所ごとに置く専任の技術者、建設工事の現場に置く監理技術者または主任技術者になることができます。
          <br />
      ...
      <div class="test-wrap -white">
        ...
        <p class="test-text">
          1級建築施工管理技士技術検定は、建築工事の施工計画や工程・品質・安全管理を行う1級建築施工管理技士の資格を取得するための国家試験です。
          <br />
          この検定は第一次検定（学科試験）と第二次検定（実地試験）の2段階に分かれており、両方に合格することで資格が与えられます。
          <br />
          この資格を取得すると、特定建設業の専任技術者や現場の監理技術者として認められ、大規模な建築工事の監督・管理ができるようになります。
          <br />
          特に公共工事では資格取得者の数が入札に影響するため、企業にとっても重要な資格です。
        </p>
      </div>
      <p class="test-heading">受験申請</p>
      <div class="test-wrap -white">
        <p class="test-text">
          1級建築施工管理技士技術検定の受験申請は、
          <a
      ...
      <div class="test-wrap -white">
        ...
        <p class="test-text">19歳以上（試験実施年度に満19歳以上となる者）</p>
        ...
        <p class="test-text">
          ...
          <br />
          <br />
          令和6年度より、施工管理技術検定の受検資格が改正されました。ただし、令和10年度までの間は、経過措置として、制度改正前の受検資格要件（旧受検資格）による第二次検定受検も可能です。
        </p>
      </div>
      <!-- 2級 建築施工管理技士技術検定 コメントアウト開始
      <p class="test-title -mb0">2級 建築施工管理技士技術検定</p>
      <div class="test-wrap -white">
        <p class="test-index">2級建築施工管理技士技術検定とは</p>
        <p class="test-text">
          2級建築施工管理技士技術検定は、建築工事の施工計画や工程・品質・安全管理を行う2級建築施工管理技士の資格を取得するための国家試験です。
          <br />
          この検定は第一次検定（学科試験）と第二次検定（実地試験）の2段階に分かれており、両方に合格することで資格が与えられます。
          <br />
          この資格を取得すると、一般建設業の専任技術者や現場の主任技術者として認められ、中小規模の建築工事の監督・管理を行うことができます。
          <br />
      ...
      <div class="test-wrap -white">
        <p class="test-text">
          ...
          初めて第二次検定を受検する場合（一次二次同時申請を含む、以下同じ）は、実務経験審査が必要となりますので、書面にて申請を行う必要があります。願書を購入して申請手続きを行ってください。
          <br />
          ただし、平成15年度以降に新規で第二次検定を受検されたことがある方は、過去提出いただいた実務経験証明書等を参照しますので、同じ級・種目・試験区分の受検申請に限り、実務経験証明書等を省略した再受検申請が可能です（欠席者を含み、辞退者を exclude します）。
        </p>
        <table class="test-table-kenchiku">
          <tr>
            <th>&emsp;</th>

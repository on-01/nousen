      ...
      <div class="follow-headline">
        <p class="follow-headline-title">
          <img
            ...
            alt="電験三種通学講座のフォローアップサービス見出し「学習が続かないという課題を、仕組みで解決する」"
          />
        </p>
      </div>
        ...
        <div class="follow-wrap">
          ...
          <div class="follow-flex">
            ...
            <div class="follow-textWrap">
              ...
              <p class="follow-text">
                能センでは、受講期間中はもちろん、受講後も継続して、資格取得に関するご質問・ご相談に<span>最大50回まで無料</span>で対応いたします。
                <br />
                <br />
                「どこから手をつければいいのか分からない」
                <br />
                ...
                <br />
                <br />
                このようなお悩みに、資格取得アドバイザーが学習状況に合わせてサポートいたします。
                <br />
                <br />
                まずは能センの教材を活用しながら、計画的に学習を進めてください。
                <br />
                学習中に迷ったときは、お気軽にご相談ください。
                <br />
                ※本サポートは、能セン講座の学習に関するご相談を対象としています。
              </p>
            </div>
          </div>
          <div class="follow-flex">
            ...
            <div class="follow-imgWrap-bottom">
              <img
                ...
                alt="電験三種通学講座の出席状況管理レポート「能センレポ」"
              />
            </div>
            <div class="follow-textWrap">
              <p class="follow-heading">🔹 能センレポとは？（2,200円／人）</p>
              <p class="follow-text">
                能センレポは、受講生の出欠状況や課題提出状況を能センが確認・集計し、担当者様向けに可視化する管理サービスです。
              </p>
              <p class="follow-heading">📅 講習終了後、翌月曜日にレポートを送信</p>
              ...
              <p class="follow-text">
                ...
                ✅ 講習終了後、担当者様へレポートを送信
                <br />
                📄 所定の日数を受講された方には、修了証を発行します
              </p>
              <p class="follow-heading">🎯 導入メリット</p>
              <p class="follow-text">
                ✅ 受講状況を見える化できる
                <br />
                ✅ 学習の停滞や欠席防止につながる
                ...
                ✅ 欠席者への迅速なフォローがしやすくなる
                <br />
                👉受講状況を「見える化」することで、学習の停滞や欠席を防ぎ、合格までの伴走支援を行います。
              </p>
            </div>
          </div>
          <div class="follow-flex">
          ...
          <div class="follow-flex">
            ...
            <div class="follow-textWrap">
              ...
              <p class="follow-text">
                ...
                <br />
                専用シートで自分のペースで学習管理ができます。
              </p>
              <p class="follow-heading">💻 サポート内容（コーチング利用時）</p>
              <p class="follow-text">
              ...
              <p class="follow-text">
                “見守られながら、確実に続ける”学習スタイルで、効率よく継続できます。
                <br />
                多くの受講生が本サービスで学習を続けています。
                <br />
                ※勉強管理システムは自己管理型（個別フォローなし）
                <br />
            ...
            <div class="follow-bottom-wrap">
              <div class="follow-bottom-leftWrap">
                <img
                  ...
                  src="../../assets/img/license_page/denken3/follow-left3.jpg"
                  alt="電験三種 第三種電気主任技術者"
                />
              </div>

      ...
      <div class="add-wrapper">
        ...
        <div class="add-studyWrap">
          ...
          <p class="add-text2">
            ...
            ▶ 試験に出るポイントを絞った講座内容
            <br />
            豊富な問題演習に加え、用語解説、ポイント解説、さらに実際の現場での経験談も交えています。
            <br />
            17歳以上の学生や、二次試験の受験資格を満たしていない方にもおすすめの内容です。
          </p>
          <br />
          ...
          <p class="add-text2">
            ...
            ▶ 二次試験対策＋経験記述の添削付き
            <br />
            二次試験対策に加え、経験記述問題の添削指導も行います。経験記述試験では、どのような問題が出題されるのか、書き方からポイント、注意点までわかりやすく説明いたします。
            <br />
            <br />

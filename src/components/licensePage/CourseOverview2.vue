  ...
  <div class="courseOverview">
    ...
    <div class="courseOverview-inner">
      <div class="courseOverview-content">
        ...
        <p class="courseOverview-text -type3">
          ▶動画撮影はテレビ撮影も手掛けているプロのカメラマンです。現地で受講しているかのような見やすい映像に仕上がっています。
        </p>
          ...
          <table>
            <tr>
              ...
              <td>
                ...
                <p><span>視聴期間18ヶ月 / サポート期間24ヶ月</span></p>
                <p class="courseOverview-td-text">
                  <del>146,300円</del>
                  ▶️【セット割】133,000円：【全科目】完全制覇セット
                </p>
                <p class="courseOverview-td-text">
                  <del>130,900円</del>
            ...
            <tr>
              ...
              <td>
                ...
                <p>・電験三種×AI学習</p>
                <p>・質問用紙（最大6枚）</p>
                <p>・修了試験問題（教育訓練給付制度利用者用）</p>
                <p>※過去問題・提出課題はダウンロード形式です。</p>
              </td>
            </tr>
            <tr>
              <th>合格率/実績</th>

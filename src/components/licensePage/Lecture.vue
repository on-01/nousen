    ...
    <div class="lecture-inner">
      ...
      <div class="lecture-section -book">
        <div class="book-wrap -left">
          <img
            src="../../assets/img/license_page/doboku_s/lecture-book3-2kyu.webp"
            alt="2級土木施工管理技士 講習会 通信講座 web講座"
          />
      ...
      <div class="lecture-section -counterplan">
        <div class="counterplan-wrap">
          ...
          <p class="counterplan-text">
            2級土木施工管理技士の合格を目指すうえで、過去問題の演習は欠かせません。
            <br />
        ...
        <div class="counterplan-wrap">
          ...
          <p class="counterplan-text">
            ...
            <br />
            解答をご提出いただき、全問正解された方には<span>【図書カード】</span>をプレゼントいたします。
          </p>
        </div>
        <div class="counterplan-wrap">
      ...
      <div class="lecture-section -counterplan2">
        ...
        <div class="counterplan-wrap">
          ...
          <div class="counterplan-text-wrap">
            ...
            <p class="counterplan-text">
              2級土木施工管理技士の第二次検定に合格するためには、過去問題を通じて出題傾向や記述のポイントをつかむことが重要です。
              <br />

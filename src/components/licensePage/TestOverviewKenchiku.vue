<template>
  <div class="test">
    <div class="test-inner">
      ...
      1級 建築施工管理技士技術検定 コメントアウト終了 -->
      <p class="test-title -mb0">2級 建築施工管理技術検定</p>
      <div class="test-wrap -white">
        <p class="test-index">2級建築施工管理技術検定とは</p>
        <p class="test-text">
          2級建築施工管理技術検定は、建築工事の施工計画や工程・品質・安全管理を行う2級建築施工管理技士の資格を取得するための国家試験です。
          <br />
          この検定は第一次検定と第二次検定の2段階に分かれており、両方に合格することで資格が与えられます。
          <br />

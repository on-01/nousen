      ...
      <div class="follow-headline">
        <p class="follow-headline-title">
          <img
            ...
            alt="電験三種オンライン講座のフォローアップサービス見出し「学習が続かないという課題を、仕組みで解決する」"
          />
        </p>
      </div>
          ...
          <div class="follow-flex">
            ...
            <div class="follow-imgWrap-bottom">
              <img
                ...
                alt="電験三種オンライン講座の学習進捗管理レポート「能センレポ」"
              />
            </div>
            <div class="follow-textWrap">
              <p class="follow-heading">
                🔹 能センレポとは？（担当者向け・2,200円／人）
              </p>
              <p class="follow-text">
                能センレポは、動画プラットフォーム上のログイン・視聴・課題提出状況をもとに、能センが学習進捗を確認・集計し、担当者様向けに可視化するサービスです。
              </p>
              <p class="follow-heading">📅 サポート期間：試験日まで</p>
              <p class="follow-heading">💻 サービス内容</p>
              <p class="follow-text">
                ✅ 動画プラットフォーム上のログイン・動画視聴・課題提出状況を確認
                <br />
                ✅ 視聴率・修了状況をひと目で確認
                <br />
                ✅ 未ログイン・未受講者を一覧で把握

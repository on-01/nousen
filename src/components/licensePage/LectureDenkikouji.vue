    ...
    <div class="lecture-inner">
      ...
      <div class="lecture-section -book">
        ...
        <div class="book-wrap -right">
          ...
          <p class="book-text700">
            ２級電気工事施工管理技士　第二次検定対策テキスト
          </p>
          <p class="book-text">
            本テキストは、能セン完全オリジナルの「２級電気工事施工管理技士
            第二次検定」対策専用教材です。
            <br />
            第二次検定では、実務経験に基づいた記述問題が中心となり、施工計画・工程管理・安全管理・品質管理などに加え、電気設備工事に関する専門知識と、的確に記述する力が求められます。
            <br />
            本テキストでは、本試験の出題傾向を徹底分析し、重要テーマを体系的に整理。現場で活かせる知識と、試験で評価されやすい記述のポイントをわかりやすくまとめています。
          </p>
        </div>
      </div>
      ...
      <div class="lecture-section -counterplan2">
        ...
        <div class="counterplan-wrap">
          ...
          <div class="counterplan-text-wrap">
            ...
            <p class="counterplan-text">
              2級電気工事施工管理技士の第二次検定に合格するためには、過去問題を通じて出題傾向や記述のポイントをつかむことが重要です。
              <br />
              能センでは、過去5年分の過去問題・解答解説を受講生に進呈しています。
              <br />
              <br />

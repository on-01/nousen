    ...
    <div class="courseOverview-inner">
      <div class="courseOverview-content">
        ...
        <p class="courseOverview-text -type4">
          ...
          改訂/改定されて行くので最新の試験対策講座（講習会）をおすすめいたします
        </p>
          ...
          <table>
            <tr>
              ...
              <td>
                <p>
                  <a
                    href="https://zensenbaikaikan.jp/access/"
                    class="courseOverview-link"
                    target="_blank"
                  >
                    専売ビル（8階）
            ...
            <tr>
              <th>
                受講料
                <p class="courseOverview-th-text">
                  （消費税・教材・添削費・送料込み）
                </p>
              </th>
              <td>
                <p class="courseOverview-td-text">
                  <del>157,300円</del>
                  ▶️【セット割】145,000円：全科目セット
                </p>
                <p class="courseOverview-td-text">
                  <del>141,900円</del>
                  ▶️【セット割】129,800円：４科目セット
                </p>
                <p>15,400円：基礎（１日）　9:00-17:00</p>
            ...
            <tr>
              <th>カリキュラム</th>
              <td>
                <p>・学習と範囲別の課題に取り組み実力をつける</p>
                <p>・合格点の60点を超える力を身に付けます（目標は80点以上）</p>
              </td>
            </tr>
            <tr>
              <th>教材/資料</th>
      ...
      <div class="courseOverview-content">
        ...
        <p class="courseOverview-text -type3">
          ...
          <br />
          各１時間程度に動画がチャプター分けがされているので、空き時間を活用して勉強ができます。
        </p>
        <p class="courseOverview-text -type2">②引き込まれる臨場感</p>
        <p class="courseOverview-text -type3">
          ▶動画撮影はテレビ撮影も手掛けているプロのカメラマンです。現地で受講しているかのような見やすい映像に仕上がっています。生の講義の臨場感をお届けいたします。
        </p>
          ...
          <table>
            <tr>
              ...
              <td>
                ...
                <p class="courseOverview-td-text">
                  <del>147,400円</del>
                  ▶️【セット割】135,000円：全科目セット
                </p>
                <p class="courseOverview-td-text">
                  <del>132,000円</del>
                  ▶️【セット割】119,000円：４科目セット
                </p>
                <p>15,400円：基礎（10時間）</p>
                <p>29,700円：理論（12時間）</p>
                <p>29,700円：電力（12時間）</p>
      ...
      <div class="courseOverview-content">
        ...
        <p class="courseOverview-text -type3">
          ...
          <br />
          途中でつまずいてしまった時も安心、講師に解説してもらえる質問用紙も最大８枚ご用意。
          <br />
          ...
          <table>
            <tr>
              ...
              <td>
                <p class="courseOverview-td-text">
                  <del>81,400円</del>
                  ▶️【セット割】62,700円：全科目（オンライン基礎＋４科目）
                </p>
                <p class="courseOverview-td-text">
                  <del>66,000円</del>
                  ▶️【セット割】49,500円：４科目（理論・電力・機械・法規）
                </p>

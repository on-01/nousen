<template>
  <div class="test">
    <div class="test-inner">
      ...
      <p class="test-heading -mt40">第三種電気主任技術者に求められる知識</p>
      <div class="test-wrap -white">
        <p class="test-text-yellow">
          電気主任技術者は、発電所、蓄電所、変電所、工場、ビルなどの受電設備や配線など、事業用電気工作物の保安・監督に従事し、電気保安に関する総合的知識が求められる。
        </p>
        <p class="test-text">
          また、その豊富な知識を活かした製品開発やサービス提供など我が国社会の電気利用を支える技術人材として強固な基盤の形成に携わっている。このうち、第三種電気主任技術者は、法令上監督できる範囲として電圧５万ボルト未満の事業用電気工作物（出力５千キロワット未満の発電所）という我が国大半の電気工作物をカバーしている。また、我が国エネルギー経済社会の脱炭素化の推進には、再生可能エネルギーの導入、移動・輸送手段の電動化、電力貯蔵等の導入が求められている。このように第三種電気主任技術者の役割は重要化し、またその活動分野の拡大が予想される。
          <br />
          さらに、事業用電気工作物の運用や電力利用における情報化の進展は著しく、その中でのサイバーセキュリティ対策も重要となりつつある。人材育成の観点からは、第三種電気主任技術者は、我が国の電力供給・利用の基幹を担う第一・二種電気主任技術者やボイラー・タービン主任技術者等と連携して業務に従事することで、
          <span class="line-yellow">将来的なステップアップ</span>
          が期待されている。
          <br />
          <br />
          このことから、法令上監督できる範囲に加え、
          <span class="line-yellow">電気に関する広範な知識</span>
          が求められている。
          <br />
          <br />
          <span>理論</span>
          ...
          <br />
          <span>電力</span>
          ：電気エネルギーの生産から流通までの広範な技術的知識とその応用力を問う。
          <br />
          <span>機械</span>
          ：電気エネルギーの利用、電気機器、通信や情報処理等に関する広範な技術的知識とその応用力を問う。
          <br />
          <span>法規</span>
          ：重要社会インフラである電気工作物とその保安について、その計画・設計・
          建設・管理に必要な法令・技術基準等に関する知識とそれらに基づく的確な判断力を問う。
        </p>
      </div>
      <p class="test-heading -mt40">受験申請</p>
      <div class="test-wrap -white">
        <p class="test-text">
          電験三種の受験申込みは、<span>原則としてインターネットから行います。</span>
          <br />
          電気技術者試験センターのマイページを作成し、必要事項・顔写真等を登録したうえで、受験方式を選択して受験手数料を支払います。
          <br />
          インターネットを利用できないなど、やむを得ない事情で書面申込みを希望する場合は、電気技術者試験センターの受験総合支援センターへお問い合わせください。
          <br />
          ※筆記方式では、試験日の約2週間前に受験票が発送されます。
          <br />
          ※CBT方式では受験票は発送されません。試験日時・会場はマイページで確認します。
        </p>
        ...
        <p class="test-text -mt20">
          ・インターネット申込みは申込み初日の１０時から最終日の１７時まで
          <br />
          ・受験手数料の入金方法は、個人申込みは、クレジットカード決済、コンビニ決済、ペイジー決済が可能
          <br />
          ・団体申込みについては、銀行振込がご利用いただけます
          <br />
          ・書面での申込みは、インターネット環境等がない方におすすめです
        </p>
      </div>
      ...
      <div class="test-wrap -orange">
        <p class="test-text">
          ...
          Based
          Testing）を導入します。CBT方式でも出題形式は、これまでと同様です。
          <br />
          <br />
          <br />
          引用元：
      ...
      <div class="test-wrap -white">
        ...
        <p class="test-text -mt20">
          <span style="font-weight: 700;">CBT方式と筆記方式はどちらがおすすめですか？</span>
          <br />
          都合の良い試験日時・会場を選び、科目ごとに別の日に受験したい方にはCBT方式がおすすめです。
          <br />
          一方、問題用紙に計算過程やメモを書き込みながら解きたい方、パソコン操作に不安がある方には筆記方式が向いています。
          <br />
      ...
      <div class="test-wrap -white">
        ...
        <p class="test-text">
          ...
          <br />
          試験日の約2週間前までに試験センターから郵送される受験票に試験場所が記載されていますので、確認してください。
          <br />
      ...
      <div class="test-wrap -orange">
        <p class="test-text">
          <span>令和8年度出題範囲</span>
          <br />
          エネルギー利用における技術革新や社会的枠組みは変化を続けており、引き続き受験者の学力を評価するために新しい問題を作成し出題する。また、必要に応じ、過去の出題からの試験問題構成を行う。この場合、近年の技術革新や法令等の改正を反映した所要の修正を行う。
      ...
      <div class="test-other -bottom">
        <p class="test-other-text">
          【法規】
          <br />
          電気工作物とその保安について、計画・設計・建設・管理に必要な法令・技術基準等に関する知識、及びそれらに基づく的確な判断力を問う。電気関係法令(電気事業法、電気工事士法、電気工事業法、電気用品安全法)、各種技術基準(電気設備技術基準、発電用風力設備技術基準、発電用太陽電池設備技術基準
          等）、及び技術的知識も踏まえた電気施設全体の運営について問う。また，電気工作物における我が国のサイバーセキュリティ対策についても出題範囲とする。
        </p>
      </div>
      ...
      <div class="test-wrap -white">
        ...
        <p class="test-text">
          (1)理論　(2)電力　(3)機械　(4)法規の４科目　１日で４科目行います。
          <br />
          <span>【筆記試験時間】</span>
          <br />
          理論: 9:15-10:45（90分）
        ...
        <p class="test-text">
          ...
          予約した試験開始時刻に開始～
          <br />
          予約した試験開始時刻から９０分後 （法規科目は、６５分後）に終了
          <br />
          <br />
          &emsp;・試験開始前に詳細な説明が行われます。試験開始時刻の20分前までには着席し、説明を待ちましょう。
          <br />
          &emsp;・試験が始まってから29分以内の遅刻は許容されますが、他の受験者に迷惑をかけないようにしましょう。
          <br />
        ...
        <table class="test-table">
          <tr>
            ...
            <td class="test-table-right">
              ...
              <br />
              ※「電気設備の技術基準の解釈について」（経済産業省の審査基準）に関するものを含みます。
            </td>
          </tr>
          <tr>
            <th class="test-table-left">試験時間</th>
      ...
      <div class="test-wrap -white">
        ...
        <p class="test-text">
          ...
          <br />
          一方、科目合格制度があり、一部の科目に合格した場合は、所定の期間その科目の試験が免除されるため、複数回に分けて4科目合格を目指すこともできます。
        </p>
      ...
      <p class="test-heading">合格率・合格者数の推移（全国平均）</p>
      <div class="test-wrap -white">
        <table class="test-table-second">
          <tr>
            <th>年度</th>
            <th>受験者数</th>
            <th>
        ...
        <p class="test-text -mt20">
          <span>電験三種の合格率から見る難易度</span>
          <br />
          直近の令和7年度の4科目合格率は、<span>上期12.9％、下期13.1％</span
          >でした。4科目すべてに合格する割合は約13％であり、電験三種は難易度の高い国家試験といえます。
          <br />
          一方、電験三種には科目別合格制度があり、4科目のうち一部の科目に合格した場合は、申請により最初に合格した試験以降、最大で連続5回まで合格科目の試験が免除されます。そのため、1回の試験ですべての科目に合格するだけでなく、複数回に分けて4科目合格を目指すこともできます。
        </p>
      </div>

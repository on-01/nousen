<template>
  <div class="workshop">
    ...
    <p class="workshop-top">
      能センのオンライン講座（WEB講座）は、電験三種の短期合格を目指す方のための受験対策講座です。
      <br />
      最新の講義動画をPC・スマートフォンから24時間いつでも視聴でき、効率よく学習を進められます。
    </p>
        ...
        <div class="add-tableWrap">
          ...
          <div class="workshop-content -ryoukin">
            <p class="workshop-text -ryoukin">
              <span>【セット】</span>
              <br />
              ✅【全科目】完全制覇セット(約58時間)▶️ 【セット割】133,000円
              <br />
              ...
              <br />
              <br />
              ✅【４科目】完全制覇セット(約48時間)▶️ 【セット割】122,100円
              <br />

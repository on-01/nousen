    ...
    <div class="schedule-inner">
      ...
      <div class="schedule-table-wrap">
          ...
          <tr>
            ...
            <td class="schedule-padding-none">
              <div>
                ...
                <p class="schedule-table-padding">1月30日(金)</p>
              </div>
            </td>
            <td>2月13日(金)～2月27日(金)</td>
            <td class="schedule-padding-none">
              <div>
                <p
                  class="schedule-td-flex-right-top schedule-table-padding-type2"
          ...
          <tr>
            ...
            <td class="schedule-padding-none">
              <div>
                ...
                <p class="schedule-table-padding">令和 9年 2月 5日(金)</p>
              </div>
            </td>
          </tr>
        </table>
        ...
        <p class="schedule-table-bottomText">
          ...
          <br />
          ※令和8年度から新受験資格の申請方法は、インターネットのみとなります
        </p>
      </div>
    </div>
  </div>

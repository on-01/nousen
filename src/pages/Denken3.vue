        ...
        <header class="header">
          ...
          <div v-show="isActiveTop === 1">
            <Explanation
              ...
              text="電験三種とは、正式名称を「第三種電気主任技術者」という、電気事業法に基づく国家資格です。第三種電気主任技術者免状を取得すると、電圧5万ボルト未満の事業用電気工作物（出力5,000キロワット以上の発電所を除く）について、電気主任技術者として工事・維持・運用の保安監督にあたることができます。<br>
                    <br>

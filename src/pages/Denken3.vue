      ...
      <div class="denken3">
        <header class="header">
          ...
          <HeroDenken3
            ...
            title="電験三種（第三種電気主任技術者）<br>試験・講座情報"
          ...
          <div v-show="isActiveTop === 1">
            <Explanation
              ...
              text="電験三種とは、正式名称を「第三種電気主任技術者」という、電気事業法に基づく国家資格です。<br>
                    第三種電気主任技術者免状を取得すると、電圧5万ボルト未満の事業用電気工作物（出力5,000キロワット以上の発電所を除く）について、電気主任技術者として工事・維持・運用の保安監督にあたることができます。<br>
                    試験は「理論・電力・機械・法規」の4科目で、年齢・学歴・実務経験などの受験資格はありません。免状取得後は、ビル・工場・発電所などの電気設備に関わる仕事で資格を活かすことができます。<br>
        ...
        meta: [
          {
            name: "description",
            content:
              "能センの電験三種講習会は【通学講座】【オンライン講座】【通信講座】があります。基礎講座の電気数学から模擬試験まで。過去問題もあり最短合格を目指せます。",
          },
          {
            key: `og:title`,
            property: `og:title`,
            content: `電験三種（第三種電気主任技術者）受験対策講習会｜能セン`,
        ...
        if (isMobile) {
          ...
          setTimeout(() => {
            window.location.href =
              "https://www.nouryoku.com/denken3/#apply-section";
          }, 10);
        } else {
          // PCの場合の処理
          window.location.href =

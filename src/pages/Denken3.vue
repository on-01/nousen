      ...
      <header class="header">
        ...
        <Explanation
            ...
            text="第三種電気主任技術者（電験三種）は、電気設備の保安監督に必要な国家資格です。<br>
                  電気設備の設計、施工、保守、点検などを行うための専門知識と技術を有する者として認められます。<br>
                  電験三種の資格を取得すると、電気設備の点検や保安をはじめ、さまざまな仕事に携われます。<br>
                  また、電気設備の監督・維持・保安は電験主任技術者資格取得者がいなければならない業務であるため、<br>
                  電験三種資格取得者を求める企業への就職・転職を有利にすることができます。"

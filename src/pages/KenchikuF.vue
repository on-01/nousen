    ...
    <Layout>
      <div class="kenchiku">
        <header class="header">
          <HeroKenchikuF
            :backImgOver="
              require('../assets/img/license_page/kenchiku_s/kenchiku_s_hero4.webp')
            "
            :backImgUnder="require('../assets/img/license_page/bg_white.jpg')"
            headTitle="令和8年度前期 / 令和8年度後期"
            title="1級建築施工管理技士<br>試験・講座情報"
...
<script>
  ...
  import HeroKenchikuF from "@/components/HeroKenchikuF.vue";
      ...
      return {
        ...
        meta: [
          ...
          },
          {
            key: `og:title`,
            property: `og:title`,
            content: `1級建築施工管理技士 受験対策講習会｜能セン-合格への近道-`,

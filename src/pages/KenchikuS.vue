      ...
      <div class="kenchiku">
        <header class="header">
          ...
          <Explanation
            ...
            1級建築施工管理技士は、大規模な建築工事や特定建設業における監理技術者として認められます。<br>
            1級は技術的に高い水準を要求される資格であり、建築現場での高い責任と専門性が求められます。<br><br>
            2級建築施工管理技士は、一般的な建設業における技術者や主任技術者として認められ、工事の監督や現場管理を担当し、工事の進捗状況や品質管理、安全対策などに関与します。2級は中小規模の工事現場に携わることができます。"
            :imagePath="

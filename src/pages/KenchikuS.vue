  ...
  <Layout>
    <div class="kenchiku">
      <header class="header">
        ...
        <Point
          :points="[
            '『担当講師が建築のエキスパート！』多くの合格者を輩出した井岡先生が担当。講師や執筆活動を通して建築の道に進む方が少しでも多く活躍することを応援しています。',
            '『合格特化型の講座』一次・二次共に合格点獲得に必要な学習項目を解説。',
            '『効率的な学習方法』＜一次＞選択問題のある科目はより効率的な学習方法を伝授。「どこを優先的に覚え、何を関連付けて理解すべきか」を指導。',
            '『経験記述問題をしっかり対策』＜二次＞工事件名の記述方法から使うべき言葉、専門用語、文章の簡潔なまとめ方、得点アップ方法など、記述のテクニックを徹底解説。',
            '『添削で合格の近道へ』＜二次＞提出していただく経験記述の課題は講師自ら個別に添削。高得点となるように直し、助言を入れてお返しします。'
          ]"
        />

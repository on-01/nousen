      ...
      <div class="contents">
        <section class="section">
          ...
          <div class="content">
            ...
            <div>
              <p>
                （一社）株式会社ＮＯＵＳＥＮは、個人情報を適切に保護し、個人情報保護法その他の法令等により認められた場合を除き、個人識別が可能な状態で同意なく第三者に開示、提供することはありません。
              </p>
            </div>
          </div>
          <div class="content">
            ...
            <div>
              <p>
                （一社）株式会社ＮＯＵＳＥＮは、個人情報保護を図るため、法令等の変更や必要に応じて、本プライバシーポリシーを改訂する事があります。その際は最新のプライバシーポリシーを本ウェブサイトに掲載いたします。
              </p>
            </div>
          </div>
          <div class="credit">

      ...
      <div class="contents">
        ...
        <section class="purpose section">
          ...
          <div class="content">
            ...
            <br />
            <ol>
              <li>1.各種資格取得のための講習会、研修会及びセミナーの企画、開催及び運営</li>
              <li>2.各種資格取得のためのオンライン講座の開設及び通信教育事業</li>
              <li>3.書籍及び教材の制作、出版及び販売</li>
              <li>4.人材採用及び就職に関するコンサルタント業務</li>
              <li>5.建築工事、土木工事、管工事及び電気工事並びに省エネルギーに関するコンサルタント業務</li>
              <li>6.前各号に附帯又は関連する一切の業務</li>
            </ol>
          </div>
        </section>

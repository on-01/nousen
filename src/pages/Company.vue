    ...
    <div class="company">
      ...
      <div class="contents">
        ...
        <section class="info section">
          ...
          <div class="content">
            ...
            <dl>
              <dt>顧問税理士</dt>
              <dd>
                <a href="https://www.progsupport.or.jp/">
                  税理士法人プログレスサポート
                </a>
              </dd>
            </dl>
        ...
        <section class="purpose section">
          ...
          <div class="content">
            当法人は、国家資格等取得に関する下記記載の各種事業を行い、合わせてその技術及び技能向上を図り、これの普及を目的とする。
            <br />
            <ol>
              <li>
                各種資格取得のための講習会、研修会及びセミナーの企画、開催及び運営
              </li>
              <li>各種資格取得のためのオンライン講座の開設及び通信教育事業</li>
              <li>書籍及び教材の制作、出版及び販売</li>
              <li>人材採用及び就職に関するコンサルタント業務</li>
              <li>
                建築工事、土木工事、管工事及び電気工事並びに省エネルギーに関するコンサルタント業務
              </li>
        ...
        <section class="history section">
          ...
          <div class="content">
            ...
            <dl>
              <dt>2025年7月</dt>
              <dd>
                事務所に太陽光発電システムを導入し、再生可能エネルギーによる電力利用を開始
              </dd>
            </dl>
            <dl>
              <dt>2025年9月</dt>
              <dd>
                全国健康保険協会東京支部より、健康経営・健康づくりに積極的に取り組む企業として
                <br />
                「健康経営・健康づくり宣言の証」を授与
              </dd>
            </dl>

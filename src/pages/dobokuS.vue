  ...
  <Layout>
    <div class="doboku">
      <header class="header">
        ...
        <Explanation
            title="土木施工管理技士とは"
            text="1・2級土木施工管理技師は、土木工事現場の施工管理業務を担当するための国家資格です。<br>
                  主任技術者や監理技術者として配置され、土木工事プロジェクトの施工計画の立案や管理、品質管理、安全管理、進捗管理など、施工現場全体の適切な運営を担保する役割を果たします。<br>
                  1級土木施工管理技師は、高度な専門知識と実務経験を要する資格です。彼らは大規模な土木工事プロジェクトを指導し、複雑な施工計画の策定や施工管理の高度な技術を駆使して、工事の品質や安全性を確保します。<br>
                  2級土木施工管理技師は、基礎的な知識と経験を要する資格です。彼らは中規模な土木工事プロジェクトを担当し、施工計画の作成や現場の安全管理、品質管理、進捗管理を行います。また、作業員の指揮命令や教育指導など、日常的な施工管理業務を効果的に遂行します。<br>
        ...
        <Study
            ...
            name2="2級土木施工管理技士"
            time2="50～100"
            text="土木施工管理技師の資格を取得するための勉強時間は個人によって異なりますが、一般的には数十時間から数百時間の学習が必要とされています。<br>
            1級土木施工管理技師の試験範囲は広く、施工計画、品質管理、安全管理、法令知識など多岐にわたります。これらの内容を十分に習得するためには、長期間にわたって学習を行う必要があります。<br>

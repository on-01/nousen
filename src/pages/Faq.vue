    ...
    <div class="faq">
      ...
      <div class="contents">
        ...
        <FaqCard
          ...
          aText="電話・FAX・能センサイトから受付しております。"
        >
          再受講や別の科目の追加申込などはお電話でも対応可能です。
        </FaqCard>
        <FaqCard
        ...
        >
          講習会初日より起算して以下の日数からキャンセル料金が発生します。
          <br />
          ...
          ※返金時の振込手数料は別途ご負担頂きます。
          <br />
          ※他社ではキャンセル不可の場合があるため、あらかじめご確認ください。
          <br />
          通学講座につきましては、受講者様のご変更、会場のご変更、または来年度への振替に対応しております。
          <br />
          ※オンライン講座・通信講座は原則として【キャンセル】および【振替】はできません。
          <br />
          なお、来年度への振替には、振替手数料（一律3,300円）をご負担いただきます。ご了承ください。
        </FaqCard>
        <FaqCard
